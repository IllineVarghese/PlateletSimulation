...
RESULTS_DIR = "results"
OUTPUT_MOVIE = os.path.join(RESULTS_DIR, "week2_day4_single_agent_chemical_field.mp4")
...
def make_chemical_field():
    """
    Create a 3D scalar field around the chemical source.
    """
    grid_size = 20
...
def render_movie(agent: GRNAgent, output_path: str) -> None:
    ...
    plotter.add_mesh(flow_arrows, color="lightsteelblue", opacity=0.50)
    ...
    plotter.add_text("Week 2 Day 4: 3D Chemical Field + Flow + Shear", font_size=14)
