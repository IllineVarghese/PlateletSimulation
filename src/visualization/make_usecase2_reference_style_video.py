...
OUT_VIDEO = OUT_DIR / "usecase2_reference_style_grn_dashboard.mp4"
...
def draw_tracked_list(draw, box, progress):
    x0, y0, x1, y1 = box
...
def make_frame(frame_idx, total_frames, data, normal_img, pert_img):
    ...
    draw_tracked_list(draw, list_box, progress)
...
def main():
    print("Creating reference-style Use Case 2 dashboard video...")
