...
RESULTS_DIR = "results"
OUTPUT_MOVIE = os.path.join(RESULTS_DIR, "week2_day2_single_agent_cylinder_presentation.mp4")
...
def render_movie(agent: GRNAgent, output_path: str) -> None:
    ...
    plotter.add_text("Week 2 Day 2: Presentation-Ready Blood Vessel View", font_size=14)
    ...
    outline_actor = plotter.add_mesh(outline_mesh, color="black", smooth_shading=True)
